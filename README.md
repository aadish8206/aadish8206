...
|:---:|:---:|:---:|
| [🎓 Alumni Management Portal](https://github.com/aadish8206/allumni-management-portal) | Centralized platform connecting alumni & institutions | `MERN` `PHP` `MySQL` |
| [🤖 Excuse Generator](https://github.com/aadish8206/excuse_generator) | AI-powered tool generating creative, realistic excuses | `Python` `AI/ML` `Jupyter` |
| [🛡️ TenderGuardian](https://github.com/aadish8206/TenderGuardian) | Smart tendering & guardian management system | `JavaScript` |
...
<img src="https://komarev.com/ghpvc/?username=aadish8206&color=6E40C9&style=for-the-badge&label=Profile+Views" alt="Profile Views"/>
